...
public class WurstplusPlateFill extends WurstplusHack {

    public WurstplusPlateFill() {
        super(WurstplusCategory.WURSTPLUS_COMBAT);

        this.name        = "Plate Fill";
        this.tag         = "PlateFill";
        this.description = "Its like hole fill, but uses pressure plates. For anvil pvp.";
    }
    ...
    private int find_in_hotbar() {
        ...
        for (int i = 0; i < 9; ++i) {
            ...
            if (stack.getItem() == Item.getItemById(70)) {
                return i;
            }
