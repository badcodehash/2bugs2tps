...
public class WurstplusOffhand extends WurstplusHack {
    ...
    WurstplusSetting gapple_on_aura = create("Gapple On Aura", "GappleOnAura", false);
    WurstplusSetting gapple_on_aura_hp = create("Gapple On Aura HP", "GappleOnAuraHP", 8, 0, 36);
    ...
    public void update() {
        ...
        if (mc.currentScreen == null || mc.currentScreen instanceof GuiInventory) {
            ...
            if (hp > totem_switch.get_value(1)) {
                ...
                //MYADDITIONS
                if (switch_mode.in("Gapple") && Wurstplus.get_hack_manager().get_module_with_tag("KillAura").is_active()) {
